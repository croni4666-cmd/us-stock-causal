...
$hits = Select-String -Path . -Pattern 'DengN|海宁|海宁东方|海宁东方学院|东方学院|dengn@gmail|@gmail\.com|C:\\Users\\DengN' -Recurse -Include '*.py','*.md','*.json','*.yaml','*.cmd' -ErrorAction SilentlyContinue
