...
**修前 10 hits**:
- `output/_tz_debug2.txt` (8 hits, Python traceback 自动含 C:\Users\project-user 路径, untracked)
- `tests/test_smoke.py:140` (2 hits, hardcode C:\Users\project-user\.mavis / .minimax skill 路径)
- `CHANGELOG.md:2311, 2334` (2 hits, 文档历史 hardcode C:\Users\project-user\.minimax)
